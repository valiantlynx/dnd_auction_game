...
def print_info(agent_id: str, states: dict, auctions: dict, prev_auctions: dict):
    ...
    for auction_id, auction in auctions.items():
        ...
        print("[id: {}]  {}d{} + {}   expected value: {:.2f}".format(auction_id, auction["num"], auction["die"],
                                                                     auction["bonus"], mean_value))
    ...
    if len(prev_auctions) > 0:
        ...
        for auction_id, auction in prev_auctions.items():
            ...
            print(
                "[id: {}] Won by agent:{}, with a bid of: {} (total {} bids were placed), got reward: {}, expected reward: {:.2f}".format(
                    auction_id,
                    winning_bid_agent,
                    winning_bid_gold,
                    number_of_bids,
