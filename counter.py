...
def CounterBot(agent_id: str, states: dict, auctions: dict, prev_auctions: dict):
    ...
    desired_capital = 5000  # Increase capital to have more gold available
    ...
    for auction_id, estimated_value in sorted_auctions:
        ...
        overbid_amount = int(optimal_bot_bid * 1.05)  # Overbid by 5%
        overbid_amount = max(overbid_amount, optimal_bot_bid + 1)  # Ensure at least 1 gold more
...
if __name__ == "__main__":
    ...
    host = "localhost"
    agent_name = "CounterBot_{}".format(random.randint(1, 1000))
    player_id = "CounterPlayer"
    port = 8001
